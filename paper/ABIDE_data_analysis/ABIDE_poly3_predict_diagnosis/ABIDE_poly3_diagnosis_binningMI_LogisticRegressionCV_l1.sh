...
#SBATCH --job-name=poly3_diagnosis_binningMI_LogisticRegressionCV_l1
...
echo "running ABIDE_poly3_diagnosis_binningMI_LogisticRegressionCV_l1.py"
...
python3 ABIDE_poly3_diagnosis_binningMI_LogisticRegressionCV_l1.py
