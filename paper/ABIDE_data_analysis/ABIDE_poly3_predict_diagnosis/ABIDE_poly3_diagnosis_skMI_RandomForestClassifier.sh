...
#SBATCH --job-name=poly3_diagnosis_skMI_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_skMI_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_skMI_RandomForestClassifier.py
