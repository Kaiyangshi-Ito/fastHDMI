...
#SBATCH --job-name=poly3_diagnosis_MI_exponential_ISJ_MLPClassifier
...
echo "running ABIDE_poly3_diagnosis_MI_exponential_ISJ_MLPClassifier.py"
...
python3 ABIDE_poly3_diagnosis_MI_exponential_ISJ_MLPClassifier.py
