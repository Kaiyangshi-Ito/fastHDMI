...
echo "running ABIDE_poly3_diagnosis_MI_tricube_scott_LogisticRegressionCV_l1.py"
...
python3 ABIDE_poly3_diagnosis_MI_tricube_scott_LogisticRegressionCV_l1.py
