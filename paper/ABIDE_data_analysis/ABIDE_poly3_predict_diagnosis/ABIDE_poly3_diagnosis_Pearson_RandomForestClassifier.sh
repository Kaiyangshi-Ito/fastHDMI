...
#SBATCH --job-name=poly3_diagnosis_Pearson_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_Pearson_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_Pearson_RandomForestClassifier.py
