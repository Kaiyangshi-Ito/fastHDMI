...
#SBATCH --job-name=poly3_diagnosis_MI_gaussian_scott_LogisticRegression
...
echo "running ABIDE_poly3_diagnosis_MI_gaussian_scott_LogisticRegression.py"
...
python3 ABIDE_poly3_diagnosis_MI_gaussian_scott_LogisticRegression.py
