...
#SBATCH --job-name=poly3_diagnosis_MI_epa_ISJ_LogisticRegression
...
echo "running ABIDE_poly3_diagnosis_MI_epa_ISJ_LogisticRegression.py"
...
python3 ABIDE_poly3_diagnosis_MI_epa_ISJ_LogisticRegression.py
