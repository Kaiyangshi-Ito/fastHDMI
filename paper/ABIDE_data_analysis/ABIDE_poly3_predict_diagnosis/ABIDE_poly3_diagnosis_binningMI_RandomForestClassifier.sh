...
#SBATCH --job-name=poly3_diagnosis_binningMI_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_binningMI_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_binningMI_RandomForestClassifier.py
