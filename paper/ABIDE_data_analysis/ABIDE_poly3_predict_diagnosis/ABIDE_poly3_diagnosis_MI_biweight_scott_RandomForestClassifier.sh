...
#SBATCH --job-name=poly3_diagnosis_MI_biweight_scott_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_MI_biweight_scott_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_MI_biweight_scott_RandomForestClassifier.py
