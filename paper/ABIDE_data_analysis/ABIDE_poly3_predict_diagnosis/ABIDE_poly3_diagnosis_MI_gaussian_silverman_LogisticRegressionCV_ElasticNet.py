...
print(r"ABIDE_poly3_age_MI_gaussian_silverman_LogisticRegressionCV_ElasticNet")
output = testing_error_num_attr(
    ...
    num_rep=20)
np.save(r"./ABIDE_poly3_diagnosis_MI_gaussian_silverman_LogisticRegressionCV_ElasticNet",
