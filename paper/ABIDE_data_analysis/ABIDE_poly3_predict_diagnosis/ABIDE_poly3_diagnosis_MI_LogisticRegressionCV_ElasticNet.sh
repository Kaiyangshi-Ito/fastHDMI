...
#SBATCH --job-name=poly3_diagnosis_MI_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_poly3_diagnosis_MI_LogisticRegressionCV_ElasticNet.py"
...
python3 ABIDE_poly3_diagnosis_MI_LogisticRegressionCV_ElasticNet.py
