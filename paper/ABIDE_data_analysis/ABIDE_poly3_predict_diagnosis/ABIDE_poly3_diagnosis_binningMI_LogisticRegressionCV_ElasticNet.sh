...
#SBATCH --job-name=poly3_diagnosis_binningMI_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_poly3_diagnosis_binningMI_LogisticRegressionCV_ElasticNet.py"
...
cp ../ABIDE_diagnosis_binningMI_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_diagnosis_binningMI_LogisticRegressionCV_ElasticNet.py
