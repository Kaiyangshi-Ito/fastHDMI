...
#SBATCH --job-name=poly3_diagnosis_skMI_MLPClassifier
...
echo "running ABIDE_poly3_diagnosis_skMI_MLPClassifier.py"
...
python3 ABIDE_poly3_diagnosis_skMI_MLPClassifier.py
