...
#SBATCH --job-name=poly3_diagnosis_binningMI_LogisticRegression
...
echo "running ABIDE_poly3_diagnosis_binningMI_LogisticRegression.py"
...
python3 ABIDE_poly3_diagnosis_binningMI_LogisticRegression.py
