...
#SBATCH --job-name=poly3_diagnosis_Pearson_MLPClassifier
...
echo "running ABIDE_poly3_diagnosis_Pearson_MLPClassifier.py"
...
python3 ABIDE_poly3_diagnosis_Pearson_MLPClassifier.py
