...
#SBATCH --job-name=poly3_diagnosis_skMI_LogisticRegressionCV_l2
...
echo "running ABIDE_poly3_diagnosis_skMI_LogisticRegressionCV_l2.py"
...
python3 ABIDE_poly3_diagnosis_skMI_LogisticRegressionCV_l2.py
