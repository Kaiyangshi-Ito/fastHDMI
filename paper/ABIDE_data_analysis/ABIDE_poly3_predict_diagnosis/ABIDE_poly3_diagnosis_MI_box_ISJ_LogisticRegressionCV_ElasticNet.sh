...
#SBATCH --job-name=poly3_diagnosis_MI_box_ISJ_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_poly3_diagnosis_MI_box_ISJ_LogisticRegressionCV_ElasticNet.py"
...
cp ../ABIDE_diagnosis_MI_box_ISJ_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_diagnosis_MI_box_ISJ_LogisticRegressionCV_ElasticNet.py
