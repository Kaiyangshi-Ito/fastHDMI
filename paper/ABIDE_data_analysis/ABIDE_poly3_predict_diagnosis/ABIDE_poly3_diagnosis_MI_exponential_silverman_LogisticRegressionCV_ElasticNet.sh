...
#SBATCH --job-name=poly3_diagnosis_MI_exponential_silverman_LogisticRegressionCV_ElasticNet
...
# ### built fastHDMI 1.23.26
# pip install fastHDMI==1.23.26 --no-cache-dir
...
pip install --no-index /home/kyang/fastHDMI-1.23.26-cp38-cp38-linux_x86_64.whl

nvidia-smi
lscpu

echo "running ABIDE_poly3_diagnosis_MI_exponential_silverman_LogisticRegressionCV_ElasticNet.py"
...
cp ../ABIDE_diagnosis_MI_exponential_silverman_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_diagnosis_MI_exponential_silverman_LogisticRegressionCV_ElasticNet.py
