...
#SBATCH --job-name=age_MI_box_silverman_MLPRegressor
...
echo "running ABIDE_age_MI_box_silverman_MLPRegressor.py"
...
python3 ABIDE_age_MI_box_silverman_MLPRegressor.py
