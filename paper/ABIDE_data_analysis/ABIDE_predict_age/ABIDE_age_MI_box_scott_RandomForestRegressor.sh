...
#SBATCH --job-name=age_MI_box_scott_RandomForestRegressor
...
echo "running ABIDE_age_MI_box_scott_RandomForestRegressor.py"
...
python3 ABIDE_age_MI_box_scott_RandomForestRegressor.py
