...
#SBATCH --job-name=age_MI_gaussian_silverman_LassoCV
...
echo "running ABIDE_age_MI_gaussian_silverman_LassoCV.py"
...
python3 ABIDE_age_MI_gaussian_silverman_LassoCV.py
