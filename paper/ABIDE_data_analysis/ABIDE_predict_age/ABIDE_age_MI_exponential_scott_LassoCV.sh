...
#SBATCH --job-name=age_MI_exponential_scott_LassoCV
...
echo "running ABIDE_age_MI_exponential_scott_LassoCV.py"
...
python3 ABIDE_age_MI_exponential_scott_LassoCV.py
