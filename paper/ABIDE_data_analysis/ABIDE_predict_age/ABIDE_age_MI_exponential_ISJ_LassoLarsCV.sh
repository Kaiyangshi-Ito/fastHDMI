...
#SBATCH --job-name=age_MI_exponential_ISJ_LassoLarsCV
...
echo "running ABIDE_age_MI_exponential_ISJ_LassoLarsCV.py"
...
python3 ABIDE_age_MI_exponential_ISJ_LassoLarsCV.py
