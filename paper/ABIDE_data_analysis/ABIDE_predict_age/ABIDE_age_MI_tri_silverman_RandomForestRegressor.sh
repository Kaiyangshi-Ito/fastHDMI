...
#SBATCH --job-name=age_MI_tri_silverman_RandomForestRegressor
...
echo "running ABIDE_age_MI_tri_silverman_RandomForestRegressor.py"
...
python3 ABIDE_age_MI_tri_silverman_RandomForestRegressor.py
