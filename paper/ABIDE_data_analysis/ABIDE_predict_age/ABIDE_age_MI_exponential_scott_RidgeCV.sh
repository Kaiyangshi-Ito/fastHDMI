...
#SBATCH --job-name=age_MI_exponential_scott_RidgeCV
...
echo "running ABIDE_age_MI_exponential_scott_RidgeCV.py"
...
python3 ABIDE_age_MI_exponential_scott_RidgeCV.py
