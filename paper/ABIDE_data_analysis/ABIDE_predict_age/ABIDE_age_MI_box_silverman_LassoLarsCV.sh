...
#SBATCH --job-name=age_MI_box_silverman_LassoLarsCV
...
echo "running ABIDE_age_MI_box_silverman_LassoLarsCV.py"
...
python3 ABIDE_age_MI_box_silverman_LassoLarsCV.py
