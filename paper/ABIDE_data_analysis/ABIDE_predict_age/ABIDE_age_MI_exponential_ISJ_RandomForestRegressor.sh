...
#SBATCH --job-name=age_MI_exponential_ISJ_RandomForestRegressor
...
echo "running ABIDE_age_MI_exponential_ISJ_RandomForestRegressor.py"
...
python3 ABIDE_age_MI_exponential_ISJ_RandomForestRegressor.py
