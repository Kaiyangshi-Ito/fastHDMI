...
#SBATCH --job-name=age_MI_gaussian_scott_MLPRegressor
...
echo "running ABIDE_age_MI_gaussian_scott_MLPRegressor.py"
...
python3 ABIDE_age_MI_gaussian_scott_MLPRegressor.py
