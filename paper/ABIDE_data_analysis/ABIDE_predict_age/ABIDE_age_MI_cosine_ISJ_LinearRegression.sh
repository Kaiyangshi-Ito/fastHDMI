...
#SBATCH --job-name=age_MI_cosine_ISJ_LinearRegression
...
echo "running ABIDE_age_MI_cosine_ISJ_LinearRegression.py"
...
python3 ABIDE_age_MI_cosine_ISJ_LinearRegression.py
