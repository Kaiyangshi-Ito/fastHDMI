...
#SBATCH --job-name=age_binningMI_RandomForestRegressor
...
echo "running ABIDE_age_binningMI_RandomForestRegressor.py"
...
python3 ABIDE_age_binningMI_RandomForestRegressor.py
