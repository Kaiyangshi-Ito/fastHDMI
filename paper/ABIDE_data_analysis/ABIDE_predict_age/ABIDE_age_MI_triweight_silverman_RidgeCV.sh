...
#SBATCH --job-name=age_MI_triweight_silverman_RidgeCV
...
echo "running ABIDE_age_MI_triweight_silverman_RidgeCV.py"
...
python3 ABIDE_age_MI_triweight_silverman_RidgeCV.py
