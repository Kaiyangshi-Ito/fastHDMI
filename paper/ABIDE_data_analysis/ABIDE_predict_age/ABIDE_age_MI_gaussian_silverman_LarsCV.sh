...
#SBATCH --job-name=age_MI_gaussian_silverman_LarsCV
...
echo "running ABIDE_age_MI_gaussian_silverman_LarsCV.py"
...
python3 ABIDE_age_MI_gaussian_silverman_LarsCV.py
