...
#SBATCH --job-name=poly3_age_MI_triweight_ISJ_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_triweight_ISJ_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_MI_triweight_ISJ_RandomForestRegressor.py
