...
#SBATCH --job-name=poly3_age_binningMI_ElasticNetCV
...
echo "running ABIDE_poly3_age_binningMI_ElasticNetCV.py"
...
python3 ABIDE_poly3_age_binningMI_ElasticNetCV.py
