...
#SBATCH --job-name=poly3_age_MI_cosine_silverman_LassoCV
...
echo "running ABIDE_poly3_age_MI_cosine_silverman_LassoCV.py"
...
python3 ABIDE_poly3_age_MI_cosine_silverman_LassoCV.py
