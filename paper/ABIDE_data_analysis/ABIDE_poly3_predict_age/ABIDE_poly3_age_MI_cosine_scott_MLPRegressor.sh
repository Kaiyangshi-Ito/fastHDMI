...
#SBATCH --job-name=poly3_age_MI_cosine_scott_MLPRegressor
...
echo "running ABIDE_poly3_age_MI_cosine_scott_MLPRegressor.py"
...
python3 ABIDE_poly3_age_MI_cosine_scott_MLPRegressor.py
