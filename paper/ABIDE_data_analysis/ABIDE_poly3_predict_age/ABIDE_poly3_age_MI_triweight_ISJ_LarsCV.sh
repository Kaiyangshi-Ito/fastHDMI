...
#SBATCH --job-name=poly3_age_MI_triweight_ISJ_LarsCV
...
echo "running ABIDE_poly3_age_MI_triweight_ISJ_LarsCV.py"
...
python3 ABIDE_poly3_age_MI_triweight_ISJ_LarsCV.py
