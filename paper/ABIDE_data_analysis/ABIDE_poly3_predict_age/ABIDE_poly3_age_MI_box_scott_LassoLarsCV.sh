...
#SBATCH --job-name=poly3_age_MI_box_scott_LassoLarsCV
...
echo "running ABIDE_poly3_age_MI_box_scott_LassoLarsCV.py"
...
python3 ABIDE_poly3_age_MI_box_scott_LassoLarsCV.py
