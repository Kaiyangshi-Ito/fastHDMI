...
print(r"ABIDE_poly3_age_MI_biweight_silverman_RandomForestRegressor")  # dep_measure, fun_name
output = testing_error_num_attr(
    ...
    outcome_name="AGE_AT_SCAN",
    num_rep=20)
np.save(r"./ABIDE_poly3_age_MI_biweight_silverman_RandomForestRegressor",
