...
#SBATCH --job-name=poly3_age_skMI_RandomForestRegressor
...
echo "running ABIDE_poly3_age_skMI_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_skMI_RandomForestRegressor.py
