...
#SBATCH --job-name=poly3_age_MI_triweight_silverman_LarsCV
...
echo "running ABIDE_poly3_age_MI_triweight_silverman_LarsCV.py"
...
python3 ABIDE_poly3_age_MI_triweight_silverman_LarsCV.py
