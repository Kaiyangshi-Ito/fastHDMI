...
#SBATCH --job-name=poly3_age_MI_epa_silverman_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_epa_silverman_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_MI_epa_silverman_RandomForestRegressor.py
