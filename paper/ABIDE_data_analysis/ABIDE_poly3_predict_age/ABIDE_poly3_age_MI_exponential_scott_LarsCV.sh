...
#SBATCH --job-name=poly3_age_MI_exponential_scott_LarsCV
...
echo "running ABIDE_poly3_age_MI_exponential_scott_LarsCV.py"
...
python3 ABIDE_poly3_age_MI_exponential_scott_LarsCV.py
