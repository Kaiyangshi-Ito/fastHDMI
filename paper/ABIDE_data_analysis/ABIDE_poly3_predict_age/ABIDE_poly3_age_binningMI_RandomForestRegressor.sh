...
#SBATCH --job-name=poly3_age_binningMI_RandomForestRegressor
...
echo "running ABIDE_poly3_age_binningMI_RandomForestRegressor.py"
...
cp ../ABIDE_age_binningMI_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_age_binningMI_RandomForestRegressor.py
