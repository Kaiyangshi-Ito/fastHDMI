...
#SBATCH --job-name=poly3_age_MI_exponential_ISJ_RidgeCV
...
echo "running ABIDE_poly3_age_MI_exponential_ISJ_RidgeCV.py"
...
python3 ABIDE_poly3_age_MI_exponential_ISJ_RidgeCV.py
