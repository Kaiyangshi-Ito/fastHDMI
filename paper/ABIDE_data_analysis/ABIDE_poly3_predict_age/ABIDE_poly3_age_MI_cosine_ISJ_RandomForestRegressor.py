...
abide_dep = np.load(os.environ["SLURM_TMPDIR"] +
                    r"/ABIDE_age_MI_cosine_ISJ_output.npy")  # dep_measure
...
print(r"ABIDE_poly3_age_MI_cosine_ISJ_RandomForestRegressor")  # dep_measure, fun_name
output = testing_error_num_attr(
    ...
    outcome_name="AGE_AT_SCAN",
    num_rep=20)
np.save(r"./ABIDE_poly3_age_MI_cosine_ISJ_RandomForestRegressor",
