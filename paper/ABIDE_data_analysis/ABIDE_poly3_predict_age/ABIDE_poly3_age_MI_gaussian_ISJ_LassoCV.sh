...
#SBATCH --job-name=poly3_age_MI_gaussian_ISJ_LassoCV
...
echo "running ABIDE_poly3_age_MI_gaussian_ISJ_LassoCV.py"
...
python3 ABIDE_poly3_age_MI_gaussian_ISJ_LassoCV.py
