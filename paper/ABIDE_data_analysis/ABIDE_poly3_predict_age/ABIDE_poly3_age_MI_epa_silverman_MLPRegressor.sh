...
#SBATCH --job-name=poly3_age_MI_epa_silverman_MLPRegressor
...
echo "running ABIDE_poly3_age_MI_epa_silverman_MLPRegressor.py"
...
python3 ABIDE_poly3_age_MI_epa_silverman_MLPRegressor.py
