...
#SBATCH --job-name=poly3_age_MI_exponential_silverman_LinearRegression
...
echo "running ABIDE_poly3_age_MI_exponential_silverman_LinearRegression.py"
...
python3 ABIDE_poly3_age_MI_exponential_silverman_LinearRegression.py
