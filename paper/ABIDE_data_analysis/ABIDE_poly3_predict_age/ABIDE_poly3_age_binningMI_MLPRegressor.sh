...
#SBATCH --job-name=poly3_age_binningMI_MLPRegressor
...
echo "running ABIDE_poly3_age_binningMI_MLPRegressor.py"
...
python3 ABIDE_poly3_age_binningMI_MLPRegressor.py
