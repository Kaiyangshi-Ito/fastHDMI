...
#SBATCH --job-name=poly3_age_MI_biweight_silverman_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_biweight_silverman_RandomForestRegressor.py"
...
cp ../ABIDE_age_MI_biweight_silverman_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_age_MI_biweight_silverman_RandomForestRegressor.py
