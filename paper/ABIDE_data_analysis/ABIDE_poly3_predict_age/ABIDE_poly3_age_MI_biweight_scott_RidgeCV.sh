...
#SBATCH --job-name=poly3_age_MI_biweight_scott_RidgeCV
...
echo "running ABIDE_poly3_age_MI_biweight_scott_RidgeCV.py"
...
python3 ABIDE_poly3_age_MI_biweight_scott_RidgeCV.py
