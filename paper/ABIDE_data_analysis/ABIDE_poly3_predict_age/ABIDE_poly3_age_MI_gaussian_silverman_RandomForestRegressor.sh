...
#SBATCH --job-name=poly3_age_MI_gaussian_silverman_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_gaussian_silverman_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_MI_gaussian_silverman_RandomForestRegressor.py
