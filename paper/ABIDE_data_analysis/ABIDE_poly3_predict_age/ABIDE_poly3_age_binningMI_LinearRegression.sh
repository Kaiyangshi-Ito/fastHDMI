...
#SBATCH --job-name=poly3_age_binningMI_LinearRegression
...
echo "running ABIDE_poly3_age_binningMI_LinearRegression.py"
...
python3 ABIDE_poly3_age_binningMI_LinearRegression.py
