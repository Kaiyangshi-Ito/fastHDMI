...
#SBATCH --job-name=poly3_age_MI_box_ISJ_MLPRegressor
...
echo "running ABIDE_poly3_age_MI_box_ISJ_MLPRegressor.py"
...
python3 ABIDE_poly3_age_MI_box_ISJ_MLPRegressor.py
