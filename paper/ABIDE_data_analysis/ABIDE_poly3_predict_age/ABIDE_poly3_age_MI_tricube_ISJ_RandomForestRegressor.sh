...
#SBATCH --job-name=poly3_age_MI_tricube_ISJ_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_tricube_ISJ_RandomForestRegressor.py"
...
cp ../ABIDE_age_MI_tricube_ISJ_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_age_MI_tricube_ISJ_RandomForestRegressor.py
