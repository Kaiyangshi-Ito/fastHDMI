...
#SBATCH --job-name=poly3_age_Pearson_RandomForestRegressor
...
echo "running ABIDE_poly3_age_Pearson_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_Pearson_RandomForestRegressor.py
