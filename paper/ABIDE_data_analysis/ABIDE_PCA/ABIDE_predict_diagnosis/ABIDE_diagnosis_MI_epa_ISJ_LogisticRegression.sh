...
#SBATCH --job-name=diagnosis_MI_epa_ISJ_LogisticRegression
...
echo "running ABIDE_diagnosis_MI_epa_ISJ_LogisticRegression.py"
...
python3 ABIDE_diagnosis_MI_epa_ISJ_LogisticRegression.py
