...
#SBATCH --job-name=diagnosis_MI_exponential_silverman_LogisticRegression
...
echo "running ABIDE_diagnosis_MI_exponential_silverman_LogisticRegression.py"
...
python3 ABIDE_diagnosis_MI_exponential_silverman_LogisticRegression.py
