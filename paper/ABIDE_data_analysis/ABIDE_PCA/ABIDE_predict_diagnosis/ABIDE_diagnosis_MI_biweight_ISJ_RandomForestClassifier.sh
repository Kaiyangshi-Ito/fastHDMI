...
#SBATCH --job-name=diagnosis_MI_biweight_ISJ_RandomForestClassifier
...
echo "running ABIDE_diagnosis_MI_biweight_ISJ_RandomForestClassifier.py"
...
python3 ABIDE_diagnosis_MI_biweight_ISJ_RandomForestClassifier.py
