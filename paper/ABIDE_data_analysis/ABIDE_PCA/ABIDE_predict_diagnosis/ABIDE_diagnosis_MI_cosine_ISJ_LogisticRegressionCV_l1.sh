...
#SBATCH --job-name=diagnosis_MI_cosine_ISJ_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_MI_cosine_ISJ_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_MI_cosine_ISJ_LogisticRegressionCV_l1.py
