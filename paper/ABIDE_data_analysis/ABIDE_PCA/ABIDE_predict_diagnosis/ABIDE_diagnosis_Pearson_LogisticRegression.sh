...
#SBATCH --job-name=diagnosis_Pearson_LogisticRegression
...
echo "running ABIDE_diagnosis_Pearson_LogisticRegression.py"
...
python3 ABIDE_diagnosis_Pearson_LogisticRegression.py
