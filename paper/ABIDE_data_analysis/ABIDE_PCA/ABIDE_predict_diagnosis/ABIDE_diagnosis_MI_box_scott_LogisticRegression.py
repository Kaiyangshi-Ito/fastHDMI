...
abide_dep = np.load(os.environ["SLURM_TMPDIR"] +
                    r"/ABIDE_diagnosis_MI_box_scott_output.npy")  # dep_measure
...
print(r"ABIDE_age_MI_box_scott_LogisticRegression")  # dep_measure, fun_name
output = testing_error_num_attr(
    ...
    num_rep=20)
np.save(r"./ABIDE_diagnosis_MI_box_scott_LogisticRegression",
