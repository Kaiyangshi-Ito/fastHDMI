...
#SBATCH --job-name=diagnosis_MI_box_silverman_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_MI_box_silverman_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_MI_box_silverman_LogisticRegressionCV_l1.py
