...
#SBATCH --job-name=diagnosis_MI_triweight_scott_MLPClassifier
...
echo "running ABIDE_diagnosis_MI_triweight_scott_MLPClassifier.py"
...
python3 ABIDE_diagnosis_MI_triweight_scott_MLPClassifier.py
