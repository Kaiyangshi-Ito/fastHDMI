...
#SBATCH --job-name=diagnosis_skMI_RandomForestClassifier
...
echo "running ABIDE_diagnosis_skMI_RandomForestClassifier.py"
...
python3 ABIDE_diagnosis_skMI_RandomForestClassifier.py
