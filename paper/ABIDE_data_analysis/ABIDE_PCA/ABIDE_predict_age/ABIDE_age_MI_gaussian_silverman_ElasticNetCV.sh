...
#SBATCH --job-name=age_MI_gaussian_silverman_ElasticNetCV
...
echo "running ABIDE_age_MI_gaussian_silverman_ElasticNetCV.py"
...
python3 ABIDE_age_MI_gaussian_silverman_ElasticNetCV.py
