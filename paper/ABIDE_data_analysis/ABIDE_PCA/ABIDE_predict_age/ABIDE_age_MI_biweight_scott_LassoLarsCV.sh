...
#SBATCH --job-name=age_MI_biweight_scott_LassoLarsCV
...
echo "running ABIDE_age_MI_biweight_scott_LassoLarsCV.py"
...
python3 ABIDE_age_MI_biweight_scott_LassoLarsCV.py
