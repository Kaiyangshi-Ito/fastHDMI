...
#SBATCH --job-name=age_MI_triweight_scott_ElasticNetCV
...
echo "running ABIDE_age_MI_triweight_scott_ElasticNetCV.py"
...
python3 ABIDE_age_MI_triweight_scott_ElasticNetCV.py
