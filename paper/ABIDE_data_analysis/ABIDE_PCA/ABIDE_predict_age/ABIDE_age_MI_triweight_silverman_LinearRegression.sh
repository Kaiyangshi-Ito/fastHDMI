...
#SBATCH --job-name=age_MI_triweight_silverman_LinearRegression
...
echo "running ABIDE_age_MI_triweight_silverman_LinearRegression.py"
...
python3 ABIDE_age_MI_triweight_silverman_LinearRegression.py
