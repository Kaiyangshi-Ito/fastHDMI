...
#SBATCH --job-name=age_MI_biweight_scott_LinearRegression
...
echo "running ABIDE_age_MI_biweight_scott_LinearRegression.py"
...
python3 ABIDE_age_MI_biweight_scott_LinearRegression.py
