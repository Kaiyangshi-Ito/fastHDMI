...
#SBATCH --job-name=poly3_diagnosis_MI_tricube_silverman_LogisticRegressionCV_l1
...
python3 ABIDE_poly3_diagnosis_MI_tricube_silverman_LogisticRegressionCV_l1.py
