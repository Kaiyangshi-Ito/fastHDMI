...
#SBATCH --job-name=poly3_diagnosis_MI_tri_silverman_LogisticRegression
...
echo "running ABIDE_poly3_diagnosis_MI_tri_silverman_LogisticRegression.py"
...
python3 ABIDE_poly3_diagnosis_MI_tri_silverman_LogisticRegression.py
