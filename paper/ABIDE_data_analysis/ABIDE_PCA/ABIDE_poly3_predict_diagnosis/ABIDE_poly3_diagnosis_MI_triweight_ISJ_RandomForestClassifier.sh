...
#SBATCH --job-name=poly3_diagnosis_MI_triweight_ISJ_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_MI_triweight_ISJ_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_MI_triweight_ISJ_RandomForestClassifier.py
