...
#SBATCH --job-name=poly3_diagnosis_MI_triweight_silverman_LogisticRegressionCV_l1
...
echo "running ABIDE_poly3_diagnosis_MI_triweight_silverman_LogisticRegressionCV_l1.py"
...
python3 ABIDE_poly3_diagnosis_MI_triweight_silverman_LogisticRegressionCV_l1.py
