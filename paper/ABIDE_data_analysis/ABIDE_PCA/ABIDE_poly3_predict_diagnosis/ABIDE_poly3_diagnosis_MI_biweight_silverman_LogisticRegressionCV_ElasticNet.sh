...
#SBATCH --job-name=poly3_diagnosis_MI_biweight_silverman_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_poly3_diagnosis_MI_biweight_silverman_LogisticRegressionCV_ElasticNet.py"

cp /home/kyang/ABIDE_data_analysis/ABIDE_PCA/ABIDE_PCA.csv $SLURM_TMPDIR/
cp ../ABIDE_columns.npy $SLURM_TMPDIR/
cp ../ABIDE_diagnosis_MI_biweight_silverman_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_diagnosis_MI_biweight_silverman_LogisticRegressionCV_ElasticNet.py
