...
#SBATCH --job-name=poly3_diagnosis_MI_exponential_silverman_RandomForestClassifier
...
echo "running ABIDE_poly3_diagnosis_MI_exponential_silverman_RandomForestClassifier.py"
...
python3 ABIDE_poly3_diagnosis_MI_exponential_silverman_RandomForestClassifier.py
