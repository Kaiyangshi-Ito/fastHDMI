...
#SBATCH --job-name=poly3_age_MI_exponential_silverman_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_exponential_silverman_RandomForestRegressor.py"

cp /home/kyang/ABIDE_data_analysis/ABIDE_PCA/ABIDE_PCA.csv $SLURM_TMPDIR/
cp ../ABIDE_columns.npy $SLURM_TMPDIR/
cp ../ABIDE_age_MI_exponential_silverman_output.npy $SLURM_TMPDIR/

python3 ABIDE_poly3_age_MI_exponential_silverman_RandomForestRegressor.py
