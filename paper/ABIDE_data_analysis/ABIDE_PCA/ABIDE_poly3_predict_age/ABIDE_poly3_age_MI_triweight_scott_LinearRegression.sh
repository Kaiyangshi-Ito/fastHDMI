...
#SBATCH --job-name=poly3_age_MI_triweight_scott_LinearRegression
...
echo "running ABIDE_poly3_age_MI_triweight_scott_LinearRegression.py"
...
python3 ABIDE_poly3_age_MI_triweight_scott_LinearRegression.py
