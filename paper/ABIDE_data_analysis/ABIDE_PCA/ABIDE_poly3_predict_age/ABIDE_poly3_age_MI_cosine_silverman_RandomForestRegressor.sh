...
#SBATCH --job-name=poly3_age_MI_cosine_silverman_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_cosine_silverman_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_MI_cosine_silverman_RandomForestRegressor.py
