...
#SBATCH --job-name=poly3_age_MI_epa_silverman_LassoLarsCV
...
echo "running ABIDE_poly3_age_MI_epa_silverman_LassoLarsCV.py"
...
python3 ABIDE_poly3_age_MI_epa_silverman_LassoLarsCV.py
