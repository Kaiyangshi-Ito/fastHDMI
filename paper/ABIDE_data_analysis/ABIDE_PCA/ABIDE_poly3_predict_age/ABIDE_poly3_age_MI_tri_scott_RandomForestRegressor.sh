...
#SBATCH --job-name=poly3_age_MI_tri_scott_RandomForestRegressor
...
echo "running ABIDE_poly3_age_MI_tri_scott_RandomForestRegressor.py"
...
python3 ABIDE_poly3_age_MI_tri_scott_RandomForestRegressor.py
