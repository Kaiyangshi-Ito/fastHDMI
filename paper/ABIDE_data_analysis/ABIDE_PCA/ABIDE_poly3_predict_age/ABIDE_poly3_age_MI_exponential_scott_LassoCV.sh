...
#SBATCH --job-name=poly3_age_MI_exponential_scott_LassoCV
...
echo "running ABIDE_poly3_age_MI_exponential_scott_LassoCV.py"
...
python3 ABIDE_poly3_age_MI_exponential_scott_LassoCV.py
