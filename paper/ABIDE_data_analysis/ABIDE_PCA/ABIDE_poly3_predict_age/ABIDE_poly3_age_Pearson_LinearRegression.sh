...
#SBATCH --job-name=poly3_age_Pearson_LinearRegression
...
echo "running ABIDE_poly3_age_Pearson_LinearRegression.py"
...
python3 ABIDE_poly3_age_Pearson_LinearRegression.py
