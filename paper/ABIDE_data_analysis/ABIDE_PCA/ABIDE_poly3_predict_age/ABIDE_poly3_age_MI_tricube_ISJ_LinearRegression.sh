...
#SBATCH --job-name=poly3_age_MI_tricube_ISJ_LinearRegression
...
echo "running ABIDE_poly3_age_MI_tricube_ISJ_LinearRegression.py"
...
python3 ABIDE_poly3_age_MI_tricube_ISJ_LinearRegression.py
