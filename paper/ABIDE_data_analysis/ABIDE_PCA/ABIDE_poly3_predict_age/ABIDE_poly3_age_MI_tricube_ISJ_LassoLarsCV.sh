...
#SBATCH --job-name=poly3_age_MI_tricube_ISJ_LassoLarsCV
...
echo "running ABIDE_poly3_age_MI_tricube_ISJ_LassoLarsCV.py"
...
python3 ABIDE_poly3_age_MI_tricube_ISJ_LassoLarsCV.py
