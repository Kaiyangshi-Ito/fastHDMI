...
#SBATCH --job-name=poly3_age_MI_cosine_scott_RidgeCV
...
echo "running ABIDE_poly3_age_MI_cosine_scott_RidgeCV.py"
...
python3 ABIDE_poly3_age_MI_cosine_scott_RidgeCV.py
