...
#SBATCH --job-name=poly3_age_MI_epa_scott_ElasticNetCV
...
echo "running ABIDE_poly3_age_MI_epa_scott_ElasticNetCV.py"
...
python3 ABIDE_poly3_age_MI_epa_scott_ElasticNetCV.py
