...
#SBATCH --job-name=poly3_age_MI_triweight_silverman_ElasticNetCV
...
echo "running ABIDE_poly3_age_MI_triweight_silverman_ElasticNetCV.py"
...
python3 ABIDE_poly3_age_MI_triweight_silverman_ElasticNetCV.py
