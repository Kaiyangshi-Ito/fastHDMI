...
#SBATCH --job-name=poly3_age_MI_epa_silverman_RidgeCV
...
echo "running ABIDE_poly3_age_MI_epa_silverman_RidgeCV.py"
...
python3 ABIDE_poly3_age_MI_epa_silverman_RidgeCV.py
