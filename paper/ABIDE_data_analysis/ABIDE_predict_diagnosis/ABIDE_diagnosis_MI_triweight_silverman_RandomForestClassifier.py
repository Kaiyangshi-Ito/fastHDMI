...
print(r"ABIDE_age_MI_triweight_silverman_RandomForestClassifier")  # dep_measure, fun_name
output = testing_error_num_attr(
    ...
    num_rep=20)
np.save(r"./ABIDE_diagnosis_MI_triweight_silverman_RandomForestClassifier",
