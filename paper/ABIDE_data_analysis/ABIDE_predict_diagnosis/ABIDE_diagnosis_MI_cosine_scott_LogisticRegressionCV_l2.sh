...
#SBATCH --job-name=diagnosis_MI_cosine_scott_LogisticRegressionCV_l2
...
echo "running ABIDE_diagnosis_MI_cosine_scott_LogisticRegressionCV_l2.py"
...
python3 ABIDE_diagnosis_MI_cosine_scott_LogisticRegressionCV_l2.py
