...
#SBATCH --job-name=diagnosis_MI_biweight_silverman_MLPClassifier
...
echo "running ABIDE_diagnosis_MI_biweight_silverman_MLPClassifier.py"
...
python3 ABIDE_diagnosis_MI_biweight_silverman_MLPClassifier.py
