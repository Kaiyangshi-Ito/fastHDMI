...
#SBATCH --job-name=diagnosis_MI_cosine_scott_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_diagnosis_MI_cosine_scott_LogisticRegressionCV_ElasticNet.py"
...
python3 ABIDE_diagnosis_MI_cosine_scott_LogisticRegressionCV_ElasticNet.py
