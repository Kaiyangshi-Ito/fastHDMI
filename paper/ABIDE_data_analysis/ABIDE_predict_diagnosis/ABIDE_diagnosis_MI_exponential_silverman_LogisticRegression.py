...
abide_dep = np.load(
    ...
    r"/ABIDE_diagnosis_MI_exponential_silverman_output.npy")  # dep_measure
...
print(r"ABIDE_age_MI_exponential_silverman_LogisticRegression")  # dep_measure, fun_name
output = testing_error_num_attr(
    ...
    fun=LogisticRegression,  # fun_name
    outcome_name="DX_GROUP",
    num_rep=20)
np.save(r"./ABIDE_diagnosis_MI_exponential_silverman_LogisticRegression",
