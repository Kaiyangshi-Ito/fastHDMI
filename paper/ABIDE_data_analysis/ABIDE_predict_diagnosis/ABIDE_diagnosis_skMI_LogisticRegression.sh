...
#SBATCH --job-name=diagnosis_skMI_LogisticRegression
...
echo "running ABIDE_diagnosis_skMI_LogisticRegression.py"
...
python3 ABIDE_diagnosis_skMI_LogisticRegression.py
