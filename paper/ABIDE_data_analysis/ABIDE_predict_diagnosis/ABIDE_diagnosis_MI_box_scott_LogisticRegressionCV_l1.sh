...
#SBATCH --job-name=diagnosis_MI_box_scott_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_MI_box_scott_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_MI_box_scott_LogisticRegressionCV_l1.py
