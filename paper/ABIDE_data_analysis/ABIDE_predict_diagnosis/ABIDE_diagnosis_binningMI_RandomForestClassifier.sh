...
#SBATCH --job-name=diagnosis_binningMI_RandomForestClassifier
...
echo "running ABIDE_diagnosis_binningMI_RandomForestClassifier.py"
...
python3 ABIDE_diagnosis_binningMI_RandomForestClassifier.py
