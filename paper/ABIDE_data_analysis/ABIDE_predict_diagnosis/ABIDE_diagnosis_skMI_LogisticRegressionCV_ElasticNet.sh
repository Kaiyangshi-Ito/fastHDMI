...
#SBATCH --job-name=diagnosis_skMI_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_diagnosis_skMI_LogisticRegressionCV_ElasticNet.py"
...
python3 ABIDE_diagnosis_skMI_LogisticRegressionCV_ElasticNet.py
