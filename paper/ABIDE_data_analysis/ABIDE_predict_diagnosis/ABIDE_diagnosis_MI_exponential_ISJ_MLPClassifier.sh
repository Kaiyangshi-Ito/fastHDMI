...
#SBATCH --job-name=diagnosis_MI_exponential_ISJ_MLPClassifier
...
echo "running ABIDE_diagnosis_MI_exponential_ISJ_MLPClassifier.py"
...
python3 ABIDE_diagnosis_MI_exponential_ISJ_MLPClassifier.py
