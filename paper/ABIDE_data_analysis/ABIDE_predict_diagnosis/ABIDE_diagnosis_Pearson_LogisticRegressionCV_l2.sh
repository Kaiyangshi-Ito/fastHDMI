...
#SBATCH --job-name=diagnosis_Pearson_LogisticRegressionCV_l2
...
echo "running ABIDE_diagnosis_Pearson_LogisticRegressionCV_l2.py"
...
python3 ABIDE_diagnosis_Pearson_LogisticRegressionCV_l2.py
