...
#SBATCH --job-name=diagnosis_MI_gaussian_scott_LogisticRegression
...
echo "running ABIDE_diagnosis_MI_gaussian_scott_LogisticRegression.py"
...
python3 ABIDE_diagnosis_MI_gaussian_scott_LogisticRegression.py
