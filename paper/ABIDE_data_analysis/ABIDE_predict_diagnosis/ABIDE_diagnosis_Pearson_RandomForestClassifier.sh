...
#SBATCH --job-name=diagnosis_Pearson_RandomForestClassifier
...
echo "running ABIDE_diagnosis_Pearson_RandomForestClassifier.py"
...
python3 ABIDE_diagnosis_Pearson_RandomForestClassifier.py
