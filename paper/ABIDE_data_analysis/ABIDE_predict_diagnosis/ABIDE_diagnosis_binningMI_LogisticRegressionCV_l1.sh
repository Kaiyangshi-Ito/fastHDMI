...
#SBATCH --job-name=diagnosis_binningMI_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_binningMI_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_binningMI_LogisticRegressionCV_l1.py
