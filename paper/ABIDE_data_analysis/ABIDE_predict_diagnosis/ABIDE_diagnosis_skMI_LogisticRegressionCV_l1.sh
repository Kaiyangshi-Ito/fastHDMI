...
#SBATCH --job-name=diagnosis_skMI_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_skMI_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_skMI_LogisticRegressionCV_l1.py
