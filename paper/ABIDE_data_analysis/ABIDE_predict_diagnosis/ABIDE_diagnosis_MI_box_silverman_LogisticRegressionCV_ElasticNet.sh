...
#SBATCH --job-name=diagnosis_MI_box_silverman_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_diagnosis_MI_box_silverman_LogisticRegressionCV_ElasticNet.py"
...
python3 ABIDE_diagnosis_MI_box_silverman_LogisticRegressionCV_ElasticNet.py
