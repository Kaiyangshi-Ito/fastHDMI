...
#SBATCH --job-name=diagnosis_MI_tri_scott_RandomForestClassifier
...
echo "running ABIDE_diagnosis_MI_tri_scott_RandomForestClassifier.py"
...
python3 ABIDE_diagnosis_MI_tri_scott_RandomForestClassifier.py
