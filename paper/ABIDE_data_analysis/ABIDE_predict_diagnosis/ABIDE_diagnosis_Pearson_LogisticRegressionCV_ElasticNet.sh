...
# ### built fastHDMI 1.18.10
# ${HOME}/wheels_builder/unmanylinuxize.sh --package fastHDMI --version 1.18.10 --python 3.8,3.9,3.10 --find_links https://files.pythonhosted.org/packages/
...
pip install --no-index /home/kyang/fastHDMI-1.18.10+computecanada-py3-none-any.whl
