...
#SBATCH --job-name=diagnosis_Pearson_LogisticRegressionCV_ElasticNet
...
echo "running ABIDE_diagnosis_Pearson_LogisticRegressionCV_ElasticNet.py"
...
python3 ABIDE_diagnosis_Pearson_LogisticRegressionCV_ElasticNet.py
