...
#SBATCH --job-name=diagnosis_MI_gaussian_ISJ_LogisticRegressionCV_l2
...
echo "running ABIDE_diagnosis_MI_gaussian_ISJ_LogisticRegressionCV_l2.py"
...
python3 ABIDE_diagnosis_MI_gaussian_ISJ_LogisticRegressionCV_l2.py
