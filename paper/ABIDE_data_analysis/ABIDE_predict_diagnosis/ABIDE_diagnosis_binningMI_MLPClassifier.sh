...
#SBATCH --job-name=diagnosis_binningMI_MLPClassifier
...
echo "running ABIDE_diagnosis_binningMI_MLPClassifier.py"
...
python3 ABIDE_diagnosis_binningMI_MLPClassifier.py
