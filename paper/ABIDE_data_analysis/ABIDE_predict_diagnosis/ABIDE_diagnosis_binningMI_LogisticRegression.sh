...
#SBATCH --job-name=diagnosis_binningMI_LogisticRegression
...
echo "running ABIDE_diagnosis_binningMI_LogisticRegression.py"
...
python3 ABIDE_diagnosis_binningMI_LogisticRegression.py
