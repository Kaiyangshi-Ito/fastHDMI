...
#SBATCH --job-name=diagnosis_Pearson_LogisticRegressionCV_l1
...
echo "running ABIDE_diagnosis_Pearson_LogisticRegressionCV_l1.py"
...
python3 ABIDE_diagnosis_Pearson_LogisticRegressionCV_l1.py
