...
#SBATCH --job-name=diagnosis_binningMI_LogisticRegressionCV_l2
...
echo "running ABIDE_diagnosis_binningMI_LogisticRegressionCV_l2.py"
...
python3 ABIDE_diagnosis_binningMI_LogisticRegressionCV_l2.py
